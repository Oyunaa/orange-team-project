...
//   if(countriesData[i].region == "Asia"){
// asiaRegion.push(countriesData[i])
// // console.log(asiaRegion);
//   }else if(countriesData[i].region == "Europe"){
//     europeRegion.push(countriesData[i])
//     console.log(europeRegion);
//   }
//   }